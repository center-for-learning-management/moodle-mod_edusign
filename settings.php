...
$settings = new admin_settingpage(
    $section, get_string('settings', 'mod_edusign'), 'moodle/site:config',
...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect(
        'edusign/feedback_plugin_for_gradebook',
        $name,
        $description,
    ...
    $setting = new admin_setting_configduration(
        'edusign/allowsubmissionsfromdate',
        $name,
        $description,
        0
    );
    ...
    $setting = new admin_setting_configcheckbox(
        'edusign/requiresubmissionstatement',
        $name,
        $description,
        0
    );
    ...
    // Constants from "locallib.php".
    $options = [-1 => get_string('unlimitedattempts', 'mod_edusign')];
    ...
    $setting = new admin_setting_configcheckbox(
        'edusign/preventsubmissionnotingroup',
        $name,
        $description,
        0
    );
    ...
    $setting = new admin_setting_configcheckbox(
        'edusign/requireallteammemberssubmit',
        $name,
        $description,
        0
    );
    ...
    $setting = new admin_setting_configempty(
        'edusign/teamsubmissiongroupingid',
        $name,
        $description
    );
    $setting->set_advanced_flag_options(admin_setting_flag::ENABLED, false);
    ...
    $setting = new admin_setting_configcheckbox(
        'edusign/sendstudentnotifications',
        $name,
        $description,
        1
    );
...
$ADMIN->add('modedusignfolder', new admin_category(
    'edusignsubmissionplugins',

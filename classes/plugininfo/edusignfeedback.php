...
class edusignfeedback extends base {
    ...
    public static function get_manage_url() {
        return new moodle_url('/mod/edusign/adminmanageplugins.php', ['subtype' => 'edusignfeedback']);
    }
    ...
    public function uninstall_cleanup() {
        ...
        $DB->delete_records('edusign_plugin_config', ['plugin' => $this->name, 'subtype' => 'edusignfeedback']);
